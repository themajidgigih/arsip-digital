            ...
            <div class="col-12" id="accordion">
                <div class="card card-gray-dark card-outline">
                    ...
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                        <div class="card-body">
                            <b>SuperAdmin</b> memiliki hak akses penuh terhadap <b>Arsip</b>Digital. Menu yang dapat diakses <b>SuperAdmin</b> antara lain:
                            ...
                            </br>4. Menu User (Tambah, Ubah, Hapus dan Lihat)
                        </div>
                    </div>
                </div>
                <div class="card card-gray-dark card-outline">
